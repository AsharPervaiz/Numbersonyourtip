...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "50 free calculators across health, finance, and daily use. No account, no data stored — here's everything the site offers and who it's for.",
  ...
  twitter: {
    title: "What Is Numbers on Your Tip?",
    description:
      "50 free calculators, no sign-up, nothing stored. Here's the tour.",
  },
};
